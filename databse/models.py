...
class test(models.Model):
    ...
    notification_id = models.BigIntegerField(max_length=1000)
    company_id= models.BigIntegerField(blank=True)

class companies(models.Model):
    id = models.IntegerField(primary_key=True)
    name= models.CharField(max_length =100)
    phone_number = models.CharField(max_length=12)
    plan_id = models.BigIntegerField(max_length=20)
    created_at= models.DateTimeField(default=datetime.now)
    createdby_id = models.BigIntegerField(default= 100)
    updated_at= models.DateTimeField(default=datetime.now)
    updatedby_id = models.BigIntegerField(default= 100)
...
class Responces(models.Model):
    ...
    question_id = models.BigIntegerField(max_length=20) #Insert Foreignkey
    interaction_id = models.BigIntegerField(max_length=20) #Insert Foreignkey
    created_at= models.DateTimeField(default=datetime.now)
    createdby_id = models.BigIntegerField(default= 100)
    updated_at= models.DateTimeField(default=datetime.now)
    updatedby_id = models.BigIntegerField(default= 100)
...
class Interactions(models.Model):
    id = models.BigIntegerField(primary_key=True)
    candidate_id = models.BigIntegerField(max_length=100) #Insert ForeignKey
    test_id = models.BigIntegerField(max_length=100) #Insert ForeignKey
...
class Score_per_question(models.Model):
    id = models.BigIntegerField(primary_key=True,)
    score_id = models.BigIntegerField(max_length=10) #insert Foreignkey
    question_id = models.BigIntegerField(max_length=10) #insert Foreignkey
...
class Questions(models.Model):
    ...
    test_id = models.BigIntegerField(max_length=10)
    created_at= models.DateTimeField(default=datetime.now)
    createdby_id = models.BigIntegerField(default= 100)
    updated_at= models.DateTimeField(default=datetime.now)
    updatedby_id = models.BigIntegerField(default= 100)
